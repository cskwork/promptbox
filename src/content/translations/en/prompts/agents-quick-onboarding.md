...
| **omp — oh-my-pi** (Windows default) | Agent (harness) | [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) | A single-binary all-in-one coding agent with LSP, a real debugger, and browser automation built in. Installed by default on Windows, where it fills the slot ego lite fills on macOS, and wired to the hub through `~/.omp/agent/` |
