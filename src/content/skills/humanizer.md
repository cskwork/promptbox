...
title: Humanizer
title_en: Humanizer
summary: "사실과 문체를 보존하면서 AI 글의 반복, 과장, 불필요한 강조를 줄이는 기본 글쓰기 스킬."
summary_en: "Edit AI-sounding prose without changing its facts, code, or the writer's voice."
tags: [skill, writing, editing, plain-language, humanizer]
source: https://github.com/blader/humanizer
author: Siqi Chen (blader)
license: MIT
order: 19
trigger: "답변·문서·보고서·댓글을 작성하거나 자연스럽게 다듬을 때 기본 적용"
install: "npx skills add blader/humanizer --global"
mirror_of: https://raw.githubusercontent.com/blader/humanizer/9862685f575c65a8247f90369951df1b3416e3d6/SKILL.md
---

## 언제 쓰나요?

답변, 문서, 보고서, Jira 댓글처럼 사람이 읽는 글을 작성하거나 다듬을 때 사용합니다.
반복되는 결론과 과장된 표현을 줄이고, 글의 목적과 독자에 맞게 문장을 다시 씁니다.
기술 문서는 중립적이고 명확하게 유지합니다.

## 기본 적용과 주의점

개인 기본 글쓰기 스킬은 Humanizer입니다. `cskwork/agent-skills`의 기본 설치 목록에 포함하며,
Unslop 등 다른 문체 교정 스킬은 명시적으로 요청할 때 사용합니다.

문체를 고쳐도 사실·수치·날짜·코드·링크는 보존합니다. 없는 근거를 보태지 않으며,
프로젝트가 정한 문서 형식과 사용자가 제시한 문체를 따릅니다.
일반 문서 작성에서는 최종 문안만 내놓는 embedded mode를 사용합니다.
