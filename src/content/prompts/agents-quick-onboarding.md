...
<div class="copy-cta">
  <div class="copy-cta__row">
    ...
    <button type="button" class="btn btn-primary pc-copy copy-cta__btn" data-copy-next aria-label="Copy the full prompt" data-aria-en="Copy the full prompt" data-aria-ko="프롬프트 전문 복사">
